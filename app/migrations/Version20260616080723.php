 ...
 */
final class Version20260616080723 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE property CHANGE criteria criteria JSON NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE property CHANGE criteria criteria LONGTEXT NOT NULL');
